...
% ---
\titulo{Statistics Self-Study module\\
  \normalsize{Solutions to Master's programme Media and Communication Science in Germany}}
...
\hypersetup{
  ...
  pdfkeywords={Statistics}{Python}{Hypothesis}{Testing},
...
\href{pic-selected-210731-1700-36.png}{\includegraphics[width=.5\linewidth]{/home/buddhilw/PP/LaTeX/AnaClara/pic-selected-210731-1700-36.png}}
...
\subsection{Resolution}
\label{sec:org8fab578}
\subsubsection{12(a) - Correlation meaning}
\label{sec:org503446b}
...
\subsection{Resolution}
\label{sec:org744daf5}
\subsubsection{14 (a) Sampling method}
\label{sec:orgc5882cc}
...
\subsection{Solution}
\label{sec:org28bceb5}
\subsubsection{1.1 Told to concentrate}
\label{sec:org5e4e938}
\begin{enumerate}
\item Populations
\label{sec:org66aa564}
The populations are:
\begin{itemize}
...
\label{sec:orga270ca1}
\begin{enumerate}
\item Populations
\label{sec:orgc8dfd59}
The populations are:
\begin{itemize}
...
\subsection{Solution}
\label{sec:org72df6a5}
\subsubsection{Population used}
\label{sec:org8ec838e}
...
\label{sec:org1ffca0d}
\begin{enumerate}
\item Find cutoff
\label{sec:orgc525d48}
...
\section{Exercise 23}
\label{sec:org44e8f95}
"Define alpha and beta."

\subsection{Solution}
\label{sec:orga777c95}
...
\label{sec:org20ccca7}
\begin{enumerate}
\item Theoretical discussion
\label{sec:org5ff0b54}
...
\label{sec:org16a5989}
\begin{enumerate}
\item Theoretical discussion
\label{sec:org3aa27c7}
...
\label{sec:orgc7c4a08}
\begin{enumerate}
\item Work with the data
\label{sec:orgf324d0e}
\begin{verbatim}
from scipy.stats import norm
import numpy as np
import matplotlib.pyplot as plt
...
\subsection{Solution}
\label{sec:org721286b}
\subsubsection{33(a) - Hypothesis steps}
\label{sec:orga39bba3}
\begin{itemize}
\item Step 1: Restate the Question as a Research Hypothesis.
\item Step 2: Determine the Characteristics of the Comparison
Distribution.
...
\subsection{Solution}
\label{sec:orgc1c883f}
\subsubsection{35 (a) Hypothesis Steps}
\label{sec:org7f9a574}
\begin{itemize}
\item Step 1: Restate the Question as a Research Hypothesis.
\item Step 2: Determine the Characteristics of the Comparison
Distribution.
...
\item \(S_{Within}\)
\label{sec:org02b7a1f}
\(S_{Within}= \dfrac{(17.9 + 15.2 + 18.0)}{3}=17.0\)

\item \(F_{observed}\)
\label{sec:org41f42c8}
...
\subsection{Solution}
\label{sec:org2a8e4f6}
\subsubsection{37(a) Hypothesis Steps}
\label{sec:orgdb513ec}
\begin{itemize}
\item Step 1: Restate the Question as a Research Hypothesis.
\item Step 2: Determine the Characteristics of the Comparison
Distribution.
...
\section{Exercise 38}
\label{sec:org0ab1339}
\subsection{Solution}
\label{sec:orgaac6eac}
\subsubsection{37(a) Hypothesis Steps}
\label{sec:org7bb0daa}
\begin{itemize}
\item Step 1: Restate the Question as a Research Hypothesis.
\item Step 2: Determine the Characteristics of the Comparison
Distribution.
...
\subsection{Solution}
\label{sec:org662e09f}
\subsubsection{39(a) Hypothesis Steps}
\label{sec:orge708bb8}
\begin{itemize}
\item Step 1: Restate the Question as a Research Hypothesis.
\item Step 2: Determine the Characteristics of the Comparison
Distribution.
...
\item S3: Cutoff
\label{sec:orgeb019df}
The standard is of \(\alpha=0.05\). Looking a table
\(\chi_{2,0.05}=5.991\). So, we have to achieve a
\(\chi_{observed}>\chi_{2,0.95}\) in order to negate \(H_0\).

\item S4: Metrics on observed data
\label{sec:org6a2ede3}
Using Python's scipy.stats,
\begin{verbatim}
